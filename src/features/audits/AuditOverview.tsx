...
export function AuditOverview() {
  ...
  return <div className="stack audit-overview">
    ...
    <section id="findings"><Card><div className="section-head"><div><span className="eyebrow">Full findings</span><h2>Evidence, meaning and recommendations</h2></div><span className="muted">Search, filter and sort the audit</span></div><IssueTable issues={audit.issues} /></Card>
  </div>
}