...
describe('AuditCommandCentre2', () => {
  it('presents a concise decision cockpit with canonical navigation targets', () => {
    ...
    const workflow = screen.getByRole('navigation', { name: /Audit workflow/i })
    ...
    expect(screen.getByRole('link', { name: /Evidence 1 1 inferred · 0 unavailable/i })).toBeInTheDocument()
    expect(screen.getByRole('link', { name: /Change 2 New or regressed/i })).toBeInTheDocument()
  })
})
