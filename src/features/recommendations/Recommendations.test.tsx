...
describe('Recommendations lifecycle UX', () => {
  it('exposes lifecycle state and only offers valid next states', () => {
    ...
    expect(screen.getByLabelText('Next step for Improve test performance')).toBeInTheDocument()
    expect(screen.getByLabelText('Evidence chain for Improve test performance')).toHaveTextContent('Finding')
    expect(screen.getByLabelText('Evidence chain for Improve test performance')).toHaveTextContent('Verification')
