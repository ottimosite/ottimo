      ...
      <div className="testimonial-group">
        ...
        <div className="testimonial-card-2">
          ...
          <div className="testimonial-2-message">
            ...
            <p className="testimonial-2-title">
              VP, Product Engineering, Hot Big Startup
            </p>
            <blockquote className="testimonial-2-content">
              It has saved us so many hours! My team is way more productive and
              happy thanks to Landing.
            </blockquote>
          </div>
        </div>
        <div className="testimonial-card-3">
          ...
          <div className="testimonial-3-message">
            ...
            <blockquote className="testimonial-3-content">
              We have been able to iterate faster and meet our aggressive sprint
              goals because of Landing.
            </blockquote>
          </div>
        </div>
      </div>
